...
class utils {
  ...
  useMonthAnimation = (activeDate, distance, onEnd = () => null) => {
    ...
    const validateAnimationValue = (value) => isNaN(value) ? 0 : value;
      ...
      transform: [
        {
          translateX: monthYearAnimation.interpolate({
            inputRange: [0, 1],
            outputRange: [0, changeWay === 'NEXT' ? -validateAnimationValue(distance) : validateAnimationValue(distance)],
          }),
        },
      ],
    };
      ...
      transform: [
        {
          translateX: monthYearAnimation.interpolate({
            inputRange: [0, 1],
            outputRange: [changeWay === 'NEXT' ? validateAnimationValue(distance) : -validateAnimationValue(distance), 0],
          }),
        },
      ],
    };
